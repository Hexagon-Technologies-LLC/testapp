...
final class DateViewCell: UICollectionViewCell {
    ...
    @IBOutlet weak var eventcountView: UIView!
    ...
    var date: Date = Date() {
        didSet {
            ...
            _ = dataSource?.dateViewCell(self, dataAttributedStringByDate: date) == nil
    ...
    var isOn: Bool = false {
        didSet {
            ...
            if(isOn)
            {
                ...
                containerView.layer.borderColor = UIColor.init(hex: "E6FD54").cgColor
