...
open class DateScrollPicker: UIView {
    ...
    private func setupInitialDays() {
        ...
        print("YYYYYYYYYYYy")
        print(monthStartDate.format(dateFormat:"dd MMM EEE yyyy"))
        
        print(Date().firstDateOfMonth().format(dateFormat:"dd MMM EEE yyyy"))
        while currentDate < monthEndDate {
            if currentDate == currentDate.firstDateOfMonth() {
                dateItems.append(DateScrollItem(date: currentDate, selected: false,hasevent: 1, separator: true))
            }
            dateItems.append(DateScrollItem(date: currentDate, selected: false,hasevent: 1, separator: false))
